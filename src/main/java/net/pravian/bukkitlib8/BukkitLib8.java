...
import net.pravian.bukkitlib8.metrics.Graph;
import net.pravian.bukkitlib8.metrics.FixedDonutPlotter;
...
public final class BukkitLib8 {
     ...
     */
    public static final String AUTHOR = "Prozza and tylerhyperHD";
    //
    ...
    private static void loadBuildInformation() {
        ...
        try {
            final InputStream in = BukkitLib8.class
                    .getResourceAsStream(
                    "/" + BukkitLib8.class
